...
1. Go to the [Zenodo Repository](https://zenodo.org/records/10698880) and download the **DLPFC12.zip** file.
2. Unzip the file.
3. Note the path to the parent folder called "DLPFC12". We will refer to this as `dir.input` in the code below.
...
*Note: In the code below, replace `"path/to/DLPFC12"` with the actual path where you unzipped the data.*
