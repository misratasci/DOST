...
def filter_num_calc(args_, comp_):
    ...
    if data_name in ['151507', '151508', '151509', '151510', '151669', '151670', '151671', '151672', '151673', '151674', '151675', '151676', 'section1']:
        adata = load_DLPFC(root_dir=data_path, section_id=data_name)
    elif data_name in ['MA']:
        adata = load_mMAMP(root_dir=data_path, section_id=data_name)
